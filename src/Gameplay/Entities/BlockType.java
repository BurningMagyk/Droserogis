...
public class BlockType
{
    ...
    public static void loadBlockTypes()
    {
        ...
        blockTypeList[3] = new BlockType("Left3",  32,16,2,0);
        blockTypeList[4] = new BlockType("Left4",  32,16,2,0);

        blockTypeList[5] = new BlockType("Right0",  32,32,0,0);
        blockTypeList[6] = new BlockType("Right1",  32,32,0,0);
        blockTypeList[7] = new BlockType("Right2",  32,32,0,0);
        blockTypeList[8] = new BlockType("Right3",  32,16,0,0);
        blockTypeList[9] = new BlockType("Right4",  32,16,0,0);

        blockTypeList[10] = new BlockType("Top0",  32,32,0,0);
        blockTypeList[11] = new BlockType("Top1",  32,32,0,1);
        blockTypeList[12] = new BlockType("Top2",  32,32,0,1);
        blockTypeList[13] = new BlockType("Top3",  32,32,0,1);
        blockTypeList[14] = new BlockType("Top4",  48,32,0,1);
        blockTypeList[15] = new BlockType("Top5",  48,32,0,2);
        ...
        blockTypeList[23] = new BlockType("Top-Left-Bend0",  32,48,2,3);
        blockTypeList[24] = new BlockType("Top-Right-Bend0",  32,48,0,3);
